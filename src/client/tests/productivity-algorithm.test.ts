...
const productivityScenarios = [
  {
    ...
    tasks: [
      { priority: 5, difficulty: 4, hours: 0.5 }, // Quick critical task
      { priority: 4, difficulty: 3, hours: 1 },   // Important task with bonus
      { priority: 3, difficulty: 2, hours: 2 },   // Standard task
    ],
    expectedTotalCoins: 240 + 144 + 60, // 444 total
...
export { calculateCoins, testScenarios, productivityScenarios };